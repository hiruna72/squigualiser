...
python/bin/python3.9 -m venv squig-venv || die "create venv failed"
...
cp -r squig-venv/lib/python3.9/site-packages/* python/lib/python3.9/site-packages/ || die "copying site-packages failed"
sed -i "s/squig-venv\/bin\/python3.9/\/usr\/bin\/env python3.9/g" python/bin/squigualiser  || die "changing headerline failed"
