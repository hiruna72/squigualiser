...
ex -k1 -m1 -c --bam "${RAW_DIR}/guppy_one_read.bam" --output "${OUTPUT_DIR}/r1k1m1.paf" || die "testcase:$TESTCASE failed"
...
ex -k9 -m2 -c --bam "${RAW_DIR}/guppy_one_read.bam" --output "${OUTPUT_DIR}/r1k9m2.paf" || die "testcase:$TESTCASE failed"
...
ex -k9 -m7 -c --bam "${RAW_DIR}/guppy_one_read.bam" --output "${OUTPUT_DIR}/r1k9m7.paf" || die "testcase:$TESTCASE failed"
...
ex -k9 -m9 -c --bam "${RAW_DIR}/guppy_one_read.bam" --output "${OUTPUT_DIR}/r1k9m9.paf" || die "testcase:$TESTCASE failed"
...
ex -k1 -m1 --bam "${RAW_DIR}/guppy_one_read.bam" --output "${OUTPUT_DIR}/r1k1m1.tsv" || die "testcase:$TESTCASE failed"
...
ex -k9 -m2 --bam "${RAW_DIR}/guppy_one_read.bam" --output "${OUTPUT_DIR}/r1k9m2.tsv" || die "testcase:$TESTCASE failed"
...
ex -k9 -m7 --bam "${RAW_DIR}/guppy_one_read.bam" --output "${OUTPUT_DIR}/r1k9m7.tsv" || die "testcase:$TESTCASE failed"
...
ex -k9 -m9 --bam "${RAW_DIR}/guppy_one_read.bam" --output "${OUTPUT_DIR}/r1k9m9.tsv" || die "testcase:$TESTCASE failed"
...
ex -k9 -m9 --bam "${RAW_DIR}/slow5-dorado.sam" --output "${OUTPUT_DIR}/dr2k9m9.tsv" || die "testcase:$TESTCASE failed"
...
ex -k9 -m9 -c --bam "${RAW_DIR}/slow5-dorado.sam" --output "${OUTPUT_DIR}/dr2k9m9.paf" || die "testcase:$TESTCASE failed"
...
ex -k1 -m1 --bam "${RAW_DIR}/slow5-dorado.sam" --output "${OUTPUT_DIR}/dr2k1m1.tsv" || die "testcase:$TESTCASE failed"
...
ex -k1 -m1 -c --bam "${RAW_DIR}/slow5-dorado.sam" --output "${OUTPUT_DIR}/dr2k1m1.paf" || die "testcase:$TESTCASE failed"
diff "${EXP_DIR}/dr2k1m1.paf" "${OUTPUT_DIR}/dr2k1m1.paf" || die "testcase:${TESTCASE} diff failed"

RAW_DIR=${RAW_DIR}/rna
EXP_DIR=${EXP_DIR}/rna
TESTCASE=2.1
info "testcase:$TESTCASE - read:2,kmer:1,move:1,output:paf rna"
ex --rna -k1 -m1 -c --bam "${RAW_DIR}/guppy_rna.sam" --output "${OUTPUT_DIR}/rna_2.1.paf" || die "testcase:$TESTCASE failed"
diff "${EXP_DIR}/rna_2.1.paf" "${OUTPUT_DIR}/rna_2.1.paf" || die "testcase:${TESTCASE} diff failed"

TESTCASE=2.2
info "testcase:$TESTCASE - read:2,kmer:1,move:1,output:tsv rna"
ex --rna -k1 -m1 --bam "${RAW_DIR}/guppy_rna.sam" --output "${OUTPUT_DIR}/rna_2.1.tsv" || die "testcase:$TESTCASE failed"
diff "${EXP_DIR}/rna_2.1.tsv" "${OUTPUT_DIR}/rna_2.1.tsv" || die "testcase:${TESTCASE} diff failed"

TESTCASE=2.3
info "testcase:$TESTCASE - read:all,kmer:1,move:1,output:paf rna"
ex --rna -k1 -m1 -c --bam "${RAW_DIR}/guppy_rna_all.sam" --output "${OUTPUT_DIR}/rna_2.3.paf" || die "testcase:$TESTCASE failed"

TESTCASE=2.4
info "testcase:$TESTCASE - read:all,kmer:1,move:1,output:tsv rna"
ex --rna -k1 -m1 --bam "${RAW_DIR}/guppy_rna_all.sam" --output "${OUTPUT_DIR}/rna_2.4.tsv" || die "testcase:$TESTCASE failed"
